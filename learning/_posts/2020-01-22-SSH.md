...
The port number `8888` is chosen randomly. But there are some general suggestions on the [right range](https://serverfault.com/questions/103626/what-is-the-maximum-port-number) of this number.
