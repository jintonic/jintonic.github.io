...
The *shell* provides a set of key combinations, or [shortcuts][], to facilitate the editing of the command line. For example, <kbd>Up</kbd> bring back the previous command, holding <kbd>Ctrl</kbd> and then pressing <kbd>a</kbd> moves your cursor to the beginning of the command line, holding <kbd>Ctrl</kbd> and pressing <kbd>e</kbd> moves it to the end. Search for *bash shortcuts* on *Google* for a complete list, or use the following command to print them out in your terminal:
