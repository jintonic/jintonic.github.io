...
how to use commands instead of the mouse to control your PC. The first command
...
above. A command is simply a text string you type into this program. You need
to press <kbd>Enter</kbd> to execute a command. The output of the executed
command is shown in the terminal and a new command line is provided below
